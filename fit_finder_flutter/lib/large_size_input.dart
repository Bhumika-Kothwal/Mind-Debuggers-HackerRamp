...
class _LargeScreenInputState extends State<LargeScreenInput> {
  ...
  Future openCamera() async {
    ...
    setState(() {
      large_size = File(cameraImage.path);
    });
  }
  ...
  Future openGallery() async {
    ...
    setState(() {
      large_size = File(galleryImage.path);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    uploadImageToServer(File imageFile,String id) async {
      ...
      var multipartFile = new http.MultipartFile('large_size', stream, length,
              ...
              child: ListBody(
                children: <Widget>[
                  ...
                  MaterialButton(
                    ...
                    onPressed: () {
                      uploadImageToServer(large_size,'2');
