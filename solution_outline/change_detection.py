...
class ChangeDetection:
    ...
    def __init__(self, image1, image2, size):
        self.image1 = image1
        self.image2 = image2
        self.size = size
    ...
    def change_area(self):
        ...
        cv2.imwrite("Images/Change_map btw user size and "+self.size+".jpg", c_map)
        img = Image.open("Images/Change_map btw user size and "+self.size+".jpg")
        img.show()
